        ...
        async with message.channel.typing():
            ...
            async with message.channel.typing():
                ...
                await message.channel.send(
                    random.choices(say_list, k=1,
                                   weights=[0.80, 1.40, 0.50, 1.20, 1.10, 0.70, 1.50, 0.70, 0.30, 0.10])[
                        0])
    ...
    # 文中の内容が一致した場合に、数種類のメッセージのうち1つをランダムに選んで返す
        ...
        async with message.channel.typing():
            ...
            async with message.channel.typing():
                ...
                # メッセージを選ぶ確率を指定する
                await message.channel.send(
                    random.choices(say_list, k=1, weights=[2.00, 1.80, 0.80, 0.50, 0.40, 0.20, 0.35, 0.10, 0.10])[
                        0])
